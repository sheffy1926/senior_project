...
//(1ULL<<IR_S_1) | (1ULL<<IR_S_2) | (1ULL<<IR_S_3) | 
...
#define IN_PIN_SEL ((1ULL<<IR_S_4) | (1ULL<<IR_S_5) | (1ULL<<IR_S_6) | (1ULL<<IR_S_7));
...
void app_main(void){
    ...
    xTaskCreate(turret_rotation_task,"turret_rotation_task", 1024, NULL, 5, NULL);
