...
static const char *TAG = "espnow_modified";

static QueueHandle_t s_espnow_queue;

//static uint8_t s_broadcast_mac[ESP_NOW_ETH_ALEN] = { 0x48, 0xC7, 0x29, 0xB6, 0x76, 0x9C };
//static uint8_t s_broadcast_mac[ESP_NOW_ETH_ALEN] = { 0x48, 0xE7, 0x29, 0x96, 0x9C, 0xEC };
